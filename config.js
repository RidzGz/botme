...
//—————「 Set Nama Bot & Own 」—————//
global.namabot = 'Randz Bot'
global.namaowner = 'RydzOfc'

//—————「 Setting Owner 」—————//
global.owner = ['6281992432544']
global.ownernomer = "6281992432544"
global.premium = ['6281992432544']
global.ultah = 'desember 13, 2023'

//—————「 Setting Donasi 」—————//
global.dana = '081992432544'

//—————「 Set Kebutuhan Button 」—————//
global.email = 'rydzofc@gmail.com'
global.namaweb = 'TikTok'
global.myweb = 'https://tiktok.com/@rydzganz'
global.region = 'Indonesia'
global.mygc = 'https://chat.whatsapp.com/BrcBsrntVYH8lV2bRy44rk'
global.myig = 'https://instagram.com/rydzganz'

//—————「 Set Wm 」—————//
global.packname = 'Rydz'
global.author = 'RydzOfc'
...
//—————「 Set Image 」—————//
//global.thumb = 'https://telegra.ph/file/b4bfc262cf2fc15df011f.png'
global.thumb = fs.readFileSync('./media/image/adrian.png')
global.kurome = { url: 'https://a.uguu.se/faLPPBPP.mp4' }
global.botname = 'Randz Bot'
global.akulaku = 'Bot By RydzOfc'
global.ttname = 'TikTok @rydzganz'
